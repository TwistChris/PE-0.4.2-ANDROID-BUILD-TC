...
class MainMenuStateFr extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.BACK)
			{
				...
				MusicBeatState.switchState(new TitleStateFr());
			}
					...
					menuItems.forEach(function(spr:FlxSprite)
					{
						...
						else
						{
							FlxFlicker.flicker(spr, 1, 0.06, false, false, function(flick:FlxFlicker)
							{
								...
								{
									case 'story_mode':
										MusicBeatState.switchState(new StoryMenuStateFr());
									case 'freeplay':
										MusicBeatState.switchState(new FreeplayStateFr());
									case 'awards':
