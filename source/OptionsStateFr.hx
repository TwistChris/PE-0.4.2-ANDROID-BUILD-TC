...
class OptionsStateFr extends MusicBeatState
{
	...
	override function update(elapsed:Float) {
		...
		if (controls.ACCEPT) {
			...
			switch(options[curSelected]) {
				...
				case 'Commandes du clavier':                                        
					openSubState(new ControlsSubstate());
				case 'Commandes de Android':
					MusicBeatState.switchState(new options.CustomControlsState());					
                                case 'Selection des langue':
...
class NotesSubstate extends MusicBeatSubstate
{
	...
	public function new() {
		...
		hsvText = new Alphabet(0, 0, "Teinte    Saturation  Luminosite", false, false, 0, 0.65);
		add(hsvText);
		changeSelection();
...
class ControlsSubstate extends MusicBeatSubstate {
	...
	private static var defaultKey:String = 'Reinitialiser les touches';
...
class LanguageSubtate extends MusicBeatSubstate
{
        ...
        static var lang:Array<Array<String>> = [];
