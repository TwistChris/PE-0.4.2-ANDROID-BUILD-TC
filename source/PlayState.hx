		...
		if (!note.wasGoodHit)
		{
			...
			if(!note.noAnimation) {
                                ...
                                if (gfcansing)
				{
                                        ...
                                        {
			                        case 0:
                                                        camFollow.set(gf.getMidpoint().x - 60 - 40, gf.getMidpoint().y - 100 - 0);
                                                        gf.playAnim('singLEFT' + daAlt, true);
                                                case 1:
					                camFollow.set(gf.getMidpoint().x - 100 - 0, gf.getMidpoint().y - 140 + 40);
                                ...
                                if (bfcansing)
				{
							...
							|| !bfspecialanim.contains(boyfriend.animation.curAnim.name))
					{
                                                        ...
                                                        {
			                                        case 0:
                                                                        camFollow.set(boyfriend.getMidpoint().x - 60 - 40, boyfriend.getMidpoint().y - 100 - 0);
                                                                        boyfriend.playAnim('singLEFT' + daAlt, true);
                                                                case 1:
                                                                        camFollow.set(boyfriend.getMidpoint().x - 100 - 0, boyfriend.getMidpoint().y - 140 + 40);
